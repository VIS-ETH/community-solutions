...
class Migration(migrations.Migration):
    ...
    CREATE MATERIALIZED VIEW categories_categorymetadata (id, category_id, documentcount, examcount_public, examcount_answered, total_cuts, answered_cuts) AS
    ...
    reverse_sql = """
    DROP MATERIALIZED VIEW categories_categorymetadata;
