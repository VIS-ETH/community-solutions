    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "long_id",
                    models.CharField(
                        default=answers.models.generate_long_id,
                        max_length=256,
                        unique=True,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="answers.AnswerSection"
            ),
        ),
        migrations.AddField(
            model_name="answer",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="downvoted_answer_set", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name="answer",
            name="expertvotes",
            field=models.ManyToManyField(
                related_name="expertvote_answer_set", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name="answer",
            name="flagged",
            field=models.ManyToManyField(
                related_name="flagged_answer_set", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name="answer",
            name="upvotes",
            field=models.ManyToManyField(
                related_name="upvoted_answer_set", to=settings.AUTH_USER_MODEL
            ),
        ),
    ]
